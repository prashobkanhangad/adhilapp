...
const kprimarycolor = Color.fromARGB(255, 44, 120, 115);
...
const heigh5 = SizedBox(height: 5);
...
const bold25 = TextStyle(fontSize: 25, fontWeight: FontWeight.bold);
const normal22 = TextStyle(fontSize: 22, );
